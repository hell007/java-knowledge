...
public class FileUtils extends org.apache.commons.io.FileUtils{
	...
	/**
	 * 将任意目录下文件名称包含指定字符串的文件删除
	 * @param str 指定字符串
	 * @param dir 目录的绝对路径
	 */
	public static void delFileNameContains(String str,String dir){
	 ...
	 * 创建单个文件
	 * @param descFileName 文件名，包含路径
	 * @return 如果创建成功，则返回文件对象，否则返回null
	 */
	public static File createNewFile(String descFileName) {
		File file = new File(descFileName);
		if (file.exists()) {
			log.debug("文件 " + descFileName + " 已存在!");
			return file;
	...
	public static String getFileName(String filePath){
		String tempPath = getFullFileName(filePath);
	 ...
	 * @return .后缀
	 */
	public static String getDotSufix(String filePath){
		int splitIndex = filePath.lastIndexOf(".");
        return filePath.substring(splitIndex);
	}
	 ...
	 * @param target
	 */
	public static void fastCopy(String source,String target) {
		...
		try {
			...
			closeAll(outc, inc, fos, fin);//关闭流和通道
			System.gc();//回收垃圾节约资源
		}
	}
	 ...
	 * @param cb
	 */
	public static void closeAll(Closeable... cb) {
		if (cb != null) {
			for (Closeable c : cb){
				try {
					if (c != null)
	...
	public static void main(String[] args) throws ParseException {
		...
		//删除文件或文件夹
		//FileUtils.delFile("F:/dists");
		
		//压缩文件
		//FileUtils.zipFiles("F:/dist", "src", "F:/dist.rar");
		
		//解压文件
		//FileUtils.unZipFiles("F:/src.zip", "F:/");
