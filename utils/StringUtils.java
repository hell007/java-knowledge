 ...
 * @Description: 字符串工具类, 继承org.apache.commons.lang3.StringUtils类. <br/>
 * @author jie
 * @date 2017年12月28日
 */
public class StringUtils extends org.apache.commons.lang3.StringUtils {
	 ...
	 * @return
	 */
	public static String underlineNextCharUpperCase(String columnName) {
	...
	/**
	 * 使用反向代理或导致ip地址获取失败，因为apache或nginx转向后获取的永远是本机
	 * 用该方法找到真实的ip地址
	 */
